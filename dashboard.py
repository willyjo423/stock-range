...
def _honesty(payload: dict) -> str:
    ...
    return (
        ...
        'found the cross-sectional tilt called direction correctly <b>51.5% '
        'of the time</b> at one week — 1.5 points better than a coin, and 51.4% '
        'over a month, on half a million independent windows.'
        ...
        'cross-sectional subtraction the tilt is actively wrong — 53.7% '
        'against a base rate of 54.4% for simply always saying up. The '
